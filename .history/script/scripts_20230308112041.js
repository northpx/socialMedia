...
const changeBg = () => {
    root.classList.setProperty('--light-color-lightness', lightColorLightness)
    root.classList.setProperty('--dark-color-lightness', darkColorLightness)
    root.classList.setProperty('--white-color-lightness', whiteColorLightness)
}
